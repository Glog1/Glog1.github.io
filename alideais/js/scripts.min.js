...
var App = {
	...
	init: function () {
		...
		let mobileLogo = document.querySelector('.js-change-logo-mob');

		burgerBtn.onclick = function () {
			//let mobileLogoTemp = mobileLogo.src;
			let mobileLogoWhite = mobileLogo.getAttribute('data-mobile-logo');
			let mobileLogoDef = mobileLogo.getAttribute('data-default-logo');
